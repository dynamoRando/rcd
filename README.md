...
## Layout Notes
Previously had `rcdadmin` for attempting to implement a web assembly front end for administering an `rcd` instance, however, web assembly appears incompatible with current Rust grpc frameworks, which is what the client leverages.
