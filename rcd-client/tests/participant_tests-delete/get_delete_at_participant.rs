pub mod grpc {
    ...
    */
    ...
    #[test]
    fn test() {
        let test_name = "get_delete_from_part_gprc";
...

        {
            ...
            let delete_at_participant_is_successful = rx.try_recv().unwrap();
    ...
    async fn participant_changes_delete_behavior(
        ...
        let response = client
            ...
            .await
            .unwrap();
        let response_behavior = DeletesToHostBehavior::from_u32(response.behavior);
...
pub mod http {
    ...
    */
    ...
    #[test]
    fn test() {
        let test_name = "get_delete_from_part_http";
