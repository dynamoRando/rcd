pub mod grpc {
    ...
    */
    ...
    #[test]
    fn test() {
        let test_name = "delta_update_from_part_gprc";
...

        {
            ...
            let h_data_hash = rx.try_recv().unwrap();
...
pub mod http {
    ...
    */
    ...
    #[test]
    fn test() {
        let test_name = "delta_update_from_part_http";
    ...
    async fn get_data_hash_for_changed_row_at_host(
        ...
        info!(
            "get_data_hash_for_changed_row_at_host attempting to connect {}",
            main_client_addr.to_full_string_with_http()
        );
