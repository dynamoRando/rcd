use rcdproto::rcdp::{SaveContractRequest, SaveContractResult, ParticipantAcceptsContractRequest, ParticipantAcceptsContractResult};
...
pub async fn save_contract(
    request: Json<SaveContractRequest>, state: &State<Core>
...
#[post("/data/contract/accepted-by-participant", format = "application/json", data = "<request>")]
pub async fn participant_accepts_contract(
    request: Json<ParticipantAcceptsContractRequest>, state: &State<Core>
