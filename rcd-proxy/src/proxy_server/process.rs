    ...
    match result_request_type {
        Ok(request_type) => match request_type {
            ...
            RequestType::HasTable => {
                let result_request = serde_json::from_str::<HasTableRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
            ...
            RequestType::SetLogicalStoragePolicy => {
                let result_request =
                    serde_json::from_str::<SetLogicalStoragePolicyRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
            ...
            RequestType::GetLogicalStoragePolicy => {
                let result_request =
                    serde_json::from_str::<GetLogicalStoragePolicyRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
            ...
            RequestType::SendParticipantContract => {
                let result_request =
                    serde_json::from_str::<SendParticipantContractRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
            ...
            RequestType::GetUpdatesToHostBehavior => {
                let result_request =
                    serde_json::from_str::<GetUpdatesToHostBehaviorRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
            ...
            RequestType::GetDeletesToHostBehavior => {
                let result_request =
                    serde_json::from_str::<GetDeletesToHostBehaviorRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
            ...
            RequestType::CooperativeWriteAtHost => {
                let result_request =
                    serde_json::from_str::<ExecuteCooperativeWriteRequest>(&request.request_json);
                match result_request {
                    Ok(request) => {
