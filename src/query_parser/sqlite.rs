use antlr_rust::{
    ...
    tree::{ParseTreeListener}, InputStream, parser_rule_context::ParserRuleContext,
};
...
use self::{
    ...
    sqliteparser::{SQLiteParser, SQLiteParserContext, SQLiteParserContextType}, sqlitelistener::SQLiteListener,
};
...
impl<'input> ParseTreeListener<'input, SQLiteParserContextType> for Listener {
...
impl<'input> SQLiteListener<'input> for Listener {
    ...
    fn enter_compound_select_stmt(&mut self, _ctx: &sqliteparser::Compound_select_stmtContext<'input>) { }

    fn exit_compound_select_stmt(&mut self, _ctx: &sqliteparser::Compound_select_stmtContext<'input>) { }
    ...
    fn enter_create_trigger_stmt(&mut self, _ctx: &sqliteparser::Create_trigger_stmtContext<'input>) { }

    fn exit_create_trigger_stmt(&mut self, _ctx: &sqliteparser::Create_trigger_stmtContext<'input>) { }
    ...
    fn enter_create_virtual_table_stmt(&mut self, _ctx: &sqliteparser::Create_virtual_table_stmtContext<'input>) { }

    fn exit_create_virtual_table_stmt(&mut self, _ctx: &sqliteparser::Create_virtual_table_stmtContext<'input>) { }
    ...
    fn enter_delete_stmt_limited(&mut self, _ctx: &sqliteparser::Delete_stmt_limitedContext<'input>) { }

    fn exit_delete_stmt_limited(&mut self, _ctx: &sqliteparser::Delete_stmt_limitedContext<'input>) { }
    ...
    fn enter_factored_select_stmt(&mut self, _ctx: &sqliteparser::Factored_select_stmtContext<'input>) { }

    fn exit_factored_select_stmt(&mut self, _ctx: &sqliteparser::Factored_select_stmtContext<'input>) { }
    ...
    fn enter_update_stmt_limited(&mut self, _ctx: &sqliteparser::Update_stmt_limitedContext<'input>) { }

    fn exit_update_stmt_limited(&mut self, _ctx: &sqliteparser::Update_stmt_limitedContext<'input>) { }
    ...
    fn enter_qualified_table_name(&mut self, _ctx: &sqliteparser::Qualified_table_nameContext<'input>) { }

    fn exit_qualified_table_name(&mut self, _ctx: &sqliteparser::Qualified_table_nameContext<'input>) { }
    ...
    fn enter_common_table_expression(&mut self, _ctx: &sqliteparser::Common_table_expressionContext<'input>) { }

    fn exit_common_table_expression(&mut self, _ctx: &sqliteparser::Common_table_expressionContext<'input>) { }
    ...
    fn enter_table_function_name(&mut self, _ctx: &sqliteparser::Table_function_nameContext<'input>) { }

    fn exit_table_function_name(&mut self, _ctx: &sqliteparser::Table_function_nameContext<'input>) { }
    ...
    fn enter_table_or_index_name(&mut self, _ctx: &sqliteparser::Table_or_index_nameContext<'input>) { }

    fn exit_table_or_index_name(&mut self, _ctx: &sqliteparser::Table_or_index_nameContext<'input>) { }
