...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for SQLiteParserExt<'input>{
	...
	fn sempred(_localctx: Option<&(dyn SQLiteParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					39 => SQLiteParser::<'input,I,_>::expr_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
pub trait ParseContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<ParseContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(EOF, 0)
}
fn sql_stmt_list_all(&self) ->  Vec<Rc<Sql_stmt_listContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sql_stmt_list(&self, i: usize) -> Option<Rc<Sql_stmt_listContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn error_all(&self) ->  Vec<Rc<ErrorContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn error(&self, i: usize) -> Option<Rc<ErrorContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
impl<'input> ErrorContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ErrorContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ErrorContextExt{
...
pub trait ErrorContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<ErrorContextExt<'input>>{
...
fn UNEXPECTED_CHAR(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ErrorContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Sql_stmt_listContext<'input> = BaseParserRuleContext<'input,Sql_stmt_listContextExt<'input>>;
...
impl<'input> Sql_stmt_listContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sql_stmt_listContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sql_stmt_listContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Sql_stmt_listContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Sql_stmt_listContextExt<'input>>{

fn sql_stmt_all(&self) ->  Vec<Rc<Sql_stmtContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sql_stmt(&self, i: usize) -> Option<Rc<Sql_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token SCOL in current rule
fn SCOL_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn SCOL(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sql_stmt_list(&mut self,)
	-> Result<Rc<Sql_stmt_listContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Sql_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sql_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sql_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Sql_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Sql_stmtContextExt<'input>>{

fn alter_table_stmt(&self) -> Option<Rc<Alter_table_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn analyze_stmt(&self) -> Option<Rc<Analyze_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn attach_stmt(&self) -> Option<Rc<Attach_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn begin_stmt(&self) -> Option<Rc<Begin_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn commit_stmt(&self) -> Option<Rc<Commit_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn compound_select_stmt(&self) -> Option<Rc<Compound_select_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn create_index_stmt(&self) -> Option<Rc<Create_index_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn create_table_stmt(&self) -> Option<Rc<Create_table_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn create_trigger_stmt(&self) -> Option<Rc<Create_trigger_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn create_view_stmt(&self) -> Option<Rc<Create_view_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn create_virtual_table_stmt(&self) -> Option<Rc<Create_virtual_table_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn delete_stmt(&self) -> Option<Rc<Delete_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn delete_stmt_limited(&self) -> Option<Rc<Delete_stmt_limitedContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn detach_stmt(&self) -> Option<Rc<Detach_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn drop_index_stmt(&self) -> Option<Rc<Drop_index_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn drop_table_stmt(&self) -> Option<Rc<Drop_table_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn drop_trigger_stmt(&self) -> Option<Rc<Drop_trigger_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn drop_view_stmt(&self) -> Option<Rc<Drop_view_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn factored_select_stmt(&self) -> Option<Rc<Factored_select_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn insert_stmt(&self) -> Option<Rc<Insert_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn pragma_stmt(&self) -> Option<Rc<Pragma_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn reindex_stmt(&self) -> Option<Rc<Reindex_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn release_stmt(&self) -> Option<Rc<Release_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn rollback_stmt(&self) -> Option<Rc<Rollback_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn savepoint_stmt(&self) -> Option<Rc<Savepoint_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn simple_select_stmt(&self) -> Option<Rc<Simple_select_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn select_stmt(&self) -> Option<Rc<Select_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn update_stmt(&self) -> Option<Rc<Update_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn update_stmt_limited(&self) -> Option<Rc<Update_stmt_limitedContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn vacuum_stmt(&self) -> Option<Rc<Vacuum_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_EXPLAIN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_QUERY(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_PLAN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sql_stmt(&mut self,)
	-> Result<Rc<Sql_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Alter_table_stmtContext<'input> = BaseParserRuleContext<'input,Alter_table_stmtContextExt<'input>>;
...
impl<'input> Alter_table_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Alter_table_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Alter_table_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Alter_table_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Alter_table_stmtContextExt<'input>>{
...
fn K_ALTER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_TABLE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_TABLE, 0)
}
fn table_name(&self) -> Option<Rc<Table_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_RENAME(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_TO(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_TO, 0)
}
fn new_table_name(&self) -> Option<Rc<New_table_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_ADD
/// Returns `None` if there is no child corresponding to token K_ADD
fn K_ADD(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_ADD, 0)
}
fn column_def(&self) -> Option<Rc<Column_defContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn database_name(&self) -> Option<Rc<Database_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token DOT
/// Returns `None` if there is no child corresponding to token DOT
fn DOT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_COLUMN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn alter_table_stmt(&mut self,)
...
pub type Analyze_stmtContext<'input> = BaseParserRuleContext<'input,Analyze_stmtContextExt<'input>>;
...
impl<'input> Analyze_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Analyze_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Analyze_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Analyze_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Analyze_stmtContextExt<'input>>{
...
fn K_ANALYZE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_ANALYZE, 0)
}
fn database_name(&self) -> Option<Rc<Database_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn table_or_index_name(&self) -> Option<Rc<Table_or_index_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token DOT
/// Returns `None` if there is no child corresponding to token DOT
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn analyze_stmt(&mut self,)
	-> Result<Rc<Analyze_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Attach_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Attach_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Attach_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Attach_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Attach_stmtContextExt<'input>>{
...
fn K_ATTACH(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_AS(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_DATABASE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn attach_stmt(&mut self,)
	-> Result<Rc<Attach_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Begin_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Begin_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Begin_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Begin_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Begin_stmtContextExt<'input>>{
...
fn K_BEGIN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_TRANSACTION(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_DEFERRED(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_IMMEDIATE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_EXCLUSIVE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_EXCLUSIVE, 0)
}
fn transaction_name(&self) -> Option<Rc<Transaction_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Begin_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			if _la==K_TRANSACTION {
				...
				recog.base.match_token(K_TRANSACTION,&mut recog.err_handler)?;
...
impl<'input> Commit_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Commit_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Commit_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Commit_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Commit_stmtContextExt<'input>>{
...
fn K_COMMIT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_END(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn commit_stmt(&mut self,)
	-> Result<Rc<Commit_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Compound_select_stmtContext<'input> = BaseParserRuleContext<'input,Compound_select_stmtContextExt<'input>>;
...
impl<'input> Compound_select_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Compound_select_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Compound_select_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Compound_select_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Compound_select_stmtContextExt<'input>>{

fn select_core_all(&self) ->  Vec<Rc<Select_coreContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn select_core(&self, i: usize) -> Option<Rc<Select_coreContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn with_clause(&self) -> Option<Rc<With_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_ORDER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_BY(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_BY, 0)
}
fn ordering_term_all(&self) ->  Vec<Rc<Ordering_termContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn ordering_term(&self, i: usize) -> Option<Rc<Ordering_termContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
fn K_LIMIT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_UNION_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_UNION(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_UNION, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_INTERSECT in current rule
fn K_INTERSECT_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_INTERSECT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_INTERSECT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_EXCEPT in current rule
fn K_EXCEPT_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_EXCEPT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_EXCEPT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token COMMA, starting from 0.
/// Returns `None` if number of children corresponding to token COMMA is less or equal than `i`.
fn COMMA(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_OFFSET(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_OFFSET, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token K_ALL in current rule
fn K_ALL_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_ALL(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn compound_select_stmt(&mut self,)
	-> Result<Rc<Compound_select_stmtContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			loop {
				...
				match recog.base.input.la(1) {
				 ...
				 K_INTERSECT 
					=> {
						...
						recog.base.match_token(K_INTERSECT,&mut recog.err_handler)?;
				...
				recog.err_handler.sync(&mut recog.base)?;
				_la = recog.base.input.la(1);
				if !(_la==K_EXCEPT || _la==K_INTERSECT || _la==K_UNION) {break}
			}
...
pub type Create_index_stmtContext<'input> = BaseParserRuleContext<'input,Create_index_stmtContextExt<'input>>;
...
impl<'input> Create_index_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Create_index_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Create_index_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Create_index_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Create_index_stmtContextExt<'input>>{
...
fn K_CREATE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_INDEX(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_INDEX, 0)
}
fn index_name(&self) -> Option<Rc<Index_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_ON
/// Returns `None` if there is no child corresponding to token K_ON
fn K_ON(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn OPEN_PAR(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(OPEN_PAR, 0)
}
fn indexed_column_all(&self) ->  Vec<Rc<Indexed_columnContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn indexed_column(&self, i: usize) -> Option<Rc<Indexed_columnContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
fn CLOSE_PAR(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_UNIQUE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_IF(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_NOT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_EXISTS(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_WHERE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn create_index_stmt(&mut self,)
...
pub type Create_table_stmtContext<'input> = BaseParserRuleContext<'input,Create_table_stmtContextExt<'input>>;
...
impl<'input> Create_table_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Create_table_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Create_table_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Create_table_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Create_table_stmtContextExt<'input>>{
...
fn column_def_all(&self) ->  Vec<Rc<Column_defContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn column_def(&self, i: usize) -> Option<Rc<Column_defContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token CLOSE_PAR
/// Returns `None` if there is no child corresponding to token CLOSE_PAR
...
fn K_TEMP(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_TEMPORARY(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn table_constraint_all(&self) ->  Vec<Rc<Table_constraintContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn table_constraint(&self, i: usize) -> Option<Rc<Table_constraintContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
fn K_WITHOUT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_WITHOUT, 0)
}
/// Retrieves first TerminalNode corresponding to token IDENTIFIER
/// Returns `None` if there is no child corresponding to token IDENTIFIER
fn IDENTIFIER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn create_table_stmt(&mut self,)
...
pub type Create_trigger_stmtContext<'input> = BaseParserRuleContext<'input,Create_trigger_stmtContextExt<'input>>;
...
impl<'input> Create_trigger_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Create_trigger_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Create_trigger_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Create_trigger_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Create_trigger_stmtContextExt<'input>>{
...
fn K_TRIGGER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_TRIGGER, 0)
}
fn trigger_name(&self) -> Option<Rc<Trigger_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_ON
/// Returns `None` if there is no child corresponding to token K_ON
...
fn K_DELETE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_INSERT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_UPDATE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn database_name_all(&self) ->  Vec<Rc<Database_nameContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn database_name(&self, i: usize) -> Option<Rc<Database_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token DOT in current rule
fn DOT_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token DOT, starting from 0.
/// Returns `None` if number of children corresponding to token DOT is less or equal than `i`.
fn DOT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_BEFORE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_AFTER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_INSTEAD(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_INSTEAD, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token K_OF in current rule
fn K_OF_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_OF(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_FOR(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_EACH(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ROW(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_WHEN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn column_name_all(&self) ->  Vec<Rc<Column_nameContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn column_name(&self, i: usize) -> Option<Rc<Column_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn update_stmt_all(&self) ->  Vec<Rc<Update_stmtContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn update_stmt(&self, i: usize) -> Option<Rc<Update_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn insert_stmt_all(&self) ->  Vec<Rc<Insert_stmtContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn insert_stmt(&self, i: usize) -> Option<Rc<Insert_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn delete_stmt_all(&self) ->  Vec<Rc<Delete_stmtContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn delete_stmt(&self, i: usize) -> Option<Rc<Delete_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn select_stmt_all(&self) ->  Vec<Rc<Select_stmtContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn select_stmt(&self, i: usize) -> Option<Rc<Select_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn create_trigger_stmt(&mut self,)
...
pub type Create_view_stmtContext<'input> = BaseParserRuleContext<'input,Create_view_stmtContextExt<'input>>;
...
impl<'input> Create_view_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Create_view_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Create_view_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Create_view_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Create_view_stmtContextExt<'input>>{
...
fn K_VIEW(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_VIEW, 0)
}
fn view_name(&self) -> Option<Rc<View_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_AS
/// Returns `None` if there is no child corresponding to token K_AS
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn create_view_stmt(&mut self,)
...
pub type Create_virtual_table_stmtContext<'input> = BaseParserRuleContext<'input,Create_virtual_table_stmtContextExt<'input>>;
...
impl<'input> Create_virtual_table_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Create_virtual_table_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Create_virtual_table_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Create_virtual_table_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Create_virtual_table_stmtContextExt<'input>>{
...
fn K_VIRTUAL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_USING(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_USING, 0)
}
fn module_name(&self) -> Option<Rc<Module_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_IF
/// Returns `None` if there is no child corresponding to token K_IF
...
fn module_argument_all(&self) ->  Vec<Rc<Module_argumentContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn module_argument(&self, i: usize) -> Option<Rc<Module_argumentContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token CLOSE_PAR
/// Returns `None` if there is no child corresponding to token CLOSE_PAR
...
impl<'input> Create_virtual_table_stmtContextAttrs<'input> for Create_virtual_table_stmtContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn create_virtual_table_stmt(&mut self,)
...
impl<'input> Delete_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Delete_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Delete_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Delete_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Delete_stmtContextExt<'input>>{
...
fn K_FROM(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_FROM, 0)
}
fn qualified_table_name(&self) -> Option<Rc<Qualified_table_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn with_clause(&self) -> Option<Rc<With_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn delete_stmt(&mut self,)
	-> Result<Rc<Delete_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Delete_stmt_limitedContext<'input> = BaseParserRuleContext<'input,Delete_stmt_limitedContextExt<'input>>;
...
impl<'input> Delete_stmt_limitedContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Delete_stmt_limitedContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Delete_stmt_limitedContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Delete_stmt_limitedContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Delete_stmt_limitedContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn delete_stmt_limited(&mut self,)
...
impl<'input> Detach_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Detach_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Detach_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Detach_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Detach_stmtContextExt<'input>>{
...
fn K_DETACH(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn detach_stmt(&mut self,)
	-> Result<Rc<Detach_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Drop_index_stmtContext<'input> = BaseParserRuleContext<'input,Drop_index_stmtContextExt<'input>>;
...
impl<'input> Drop_index_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Drop_index_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Drop_index_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Drop_index_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Drop_index_stmtContextExt<'input>>{
...
fn K_DROP(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn drop_index_stmt(&mut self,)
	-> Result<Rc<Drop_index_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Drop_table_stmtContext<'input> = BaseParserRuleContext<'input,Drop_table_stmtContextExt<'input>>;
...
impl<'input> Drop_table_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Drop_table_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Drop_table_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Drop_table_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Drop_table_stmtContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn drop_table_stmt(&mut self,)
	-> Result<Rc<Drop_table_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Drop_trigger_stmtContext<'input> = BaseParserRuleContext<'input,Drop_trigger_stmtContextExt<'input>>;
...
impl<'input> Drop_trigger_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Drop_trigger_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Drop_trigger_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Drop_trigger_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Drop_trigger_stmtContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn drop_trigger_stmt(&mut self,)
...
pub type Drop_view_stmtContext<'input> = BaseParserRuleContext<'input,Drop_view_stmtContextExt<'input>>;
...
impl<'input> Drop_view_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Drop_view_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Drop_view_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Drop_view_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Drop_view_stmtContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn drop_view_stmt(&mut self,)
	-> Result<Rc<Drop_view_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Factored_select_stmtContext<'input> = BaseParserRuleContext<'input,Factored_select_stmtContextExt<'input>>;
...
impl<'input> Factored_select_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Factored_select_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Factored_select_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Factored_select_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Factored_select_stmtContextExt<'input>>{
...
fn compound_operator_all(&self) ->  Vec<Rc<Compound_operatorContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn compound_operator(&self, i: usize) -> Option<Rc<Compound_operatorContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token K_ORDER
/// Returns `None` if there is no child corresponding to token K_ORDER
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn factored_select_stmt(&mut self,)
...
impl<'input> Insert_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Insert_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Insert_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Insert_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Insert_stmtContextExt<'input>>{
...
fn K_INTO(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_REPLACE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_OR(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ROLLBACK(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ABORT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_FAIL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_IGNORE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_VALUES(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_VALUES, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token OPEN_PAR in current rule
fn OPEN_PAR_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn OPEN_PAR(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn CLOSE_PAR_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn CLOSE_PAR(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_DEFAULT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn insert_stmt(&mut self,)
	-> Result<Rc<Insert_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Pragma_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Pragma_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Pragma_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Pragma_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Pragma_stmtContextExt<'input>>{
...
fn K_PRAGMA(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_PRAGMA, 0)
}
fn pragma_name(&self) -> Option<Rc<Pragma_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn database_name(&self) -> Option<Rc<Database_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
fn ASSIGN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(ASSIGN, 0)
}
fn pragma_value(&self) -> Option<Rc<Pragma_valueContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_PAR
/// Returns `None` if there is no child corresponding to token OPEN_PAR
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pragma_stmt(&mut self,)
	-> Result<Rc<Pragma_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Reindex_stmtContext<'input> = BaseParserRuleContext<'input,Reindex_stmtContextExt<'input>>;
...
impl<'input> Reindex_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Reindex_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Reindex_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Reindex_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Reindex_stmtContextExt<'input>>{
...
fn K_REINDEX(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_REINDEX, 0)
}
fn collation_name(&self) -> Option<Rc<Collation_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn table_name(&self) -> Option<Rc<Table_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn reindex_stmt(&mut self,)
	-> Result<Rc<Reindex_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Release_stmtContext<'input> = BaseParserRuleContext<'input,Release_stmtContextExt<'input>>;
...
impl<'input> Release_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Release_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Release_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Release_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Release_stmtContextExt<'input>>{
...
fn K_RELEASE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_RELEASE, 0)
}
fn savepoint_name(&self) -> Option<Rc<Savepoint_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_SAVEPOINT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn release_stmt(&mut self,)
	-> Result<Rc<Release_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match  recog.interpreter.adaptive_predict(95,&mut recog.base)? {
				x if x == 1=>{
					...
					recog.base.match_token(K_SAVEPOINT,&mut recog.err_handler)?;
...
pub type Rollback_stmtContext<'input> = BaseParserRuleContext<'input,Rollback_stmtContextExt<'input>>;
...
impl<'input> Rollback_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Rollback_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Rollback_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Rollback_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Rollback_stmtContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn rollback_stmt(&mut self,)
	-> Result<Rc<Rollback_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Savepoint_stmtContext<'input> = BaseParserRuleContext<'input,Savepoint_stmtContextExt<'input>>;
...
impl<'input> Savepoint_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Savepoint_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Savepoint_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Savepoint_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Savepoint_stmtContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn savepoint_stmt(&mut self,)
	-> Result<Rc<Savepoint_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Simple_select_stmtContext<'input> = BaseParserRuleContext<'input,Simple_select_stmtContextExt<'input>>;
...
impl<'input> Simple_select_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Simple_select_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Simple_select_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Simple_select_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Simple_select_stmtContextExt<'input>>{

fn select_core(&self) -> Option<Rc<Select_coreContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn with_clause(&self) -> Option<Rc<With_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn simple_select_stmt(&mut self,)
...
impl<'input> Select_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Select_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Select_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Select_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Select_stmtContextExt<'input>>{

fn select_or_values_all(&self) ->  Vec<Rc<Select_or_valuesContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn select_or_values(&self, i: usize) -> Option<Rc<Select_or_valuesContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn with_clause(&self) -> Option<Rc<With_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn select_stmt(&mut self,)
	-> Result<Rc<Select_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Select_or_valuesContext<'input> = BaseParserRuleContext<'input,Select_or_valuesContextExt<'input>>;
...
impl<'input> Select_or_valuesContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Select_or_valuesContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Select_or_valuesContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Select_or_valuesContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Select_or_valuesContextExt<'input>>{
...
fn K_SELECT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_SELECT, 0)
}
fn result_column_all(&self) ->  Vec<Rc<Result_columnContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn result_column(&self, i: usize) -> Option<Rc<Result_columnContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
...
fn K_GROUP(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_DISTINCT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ALL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_ALL, 0)
}
fn table_or_subquery_all(&self) ->  Vec<Rc<Table_or_subqueryContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn table_or_subquery(&self, i: usize) -> Option<Rc<Table_or_subqueryContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn join_clause(&self) -> Option<Rc<Join_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_HAVING(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn select_or_values(&mut self,)
...
impl<'input> Update_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Update_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Update_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Update_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Update_stmtContextExt<'input>>{
...
fn K_SET(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn ASSIGN_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ASSIGN(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn update_stmt(&mut self,)
	-> Result<Rc<Update_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Update_stmt_limitedContext<'input> = BaseParserRuleContext<'input,Update_stmt_limitedContextExt<'input>>;
...
impl<'input> Update_stmt_limitedContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Update_stmt_limitedContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Update_stmt_limitedContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Update_stmt_limitedContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Update_stmt_limitedContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn update_stmt_limited(&mut self,)
...
impl<'input> Vacuum_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Vacuum_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Vacuum_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Vacuum_stmtContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Vacuum_stmtContextExt<'input>>{
...
fn K_VACUUM(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn vacuum_stmt(&mut self,)
	-> Result<Rc<Vacuum_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Column_defContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Column_defContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Column_defContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Column_defContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Column_defContextExt<'input>>{

fn column_name(&self) -> Option<Rc<Column_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn type_name(&self) -> Option<Rc<Type_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn column_constraint_all(&self) ->  Vec<Rc<Column_constraintContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn column_constraint(&self, i: usize) -> Option<Rc<Column_constraintContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn column_def(&mut self,)
	-> Result<Rc<Column_defContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Type_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Type_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Type_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Type_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Type_nameContextExt<'input>>{
...
fn signed_number_all(&self) ->  Vec<Rc<Signed_numberContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn signed_number(&self, i: usize) -> Option<Rc<Signed_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token CLOSE_PAR
/// Returns `None` if there is no child corresponding to token CLOSE_PAR
...
fn COMMA(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn type_name(&mut self,)
	-> Result<Rc<Type_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Column_constraintContext<'input> = BaseParserRuleContext<'input,Column_constraintContextExt<'input>>;
...
impl<'input> Column_constraintContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Column_constraintContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Column_constraintContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Column_constraintContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Column_constraintContextExt<'input>>{
...
fn K_PRIMARY(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_KEY(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_KEY, 0)
}
fn conflict_clause(&self) -> Option<Rc<Conflict_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_NULL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CHECK(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_COLLATE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_COLLATE, 0)
}
fn collation_name(&self) -> Option<Rc<Collation_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn foreign_key_clause(&self) -> Option<Rc<Foreign_key_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_CONSTRAINT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_CONSTRAINT, 0)
}
fn name(&self) -> Option<Rc<NameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn signed_number(&self) -> Option<Rc<Signed_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn literal_value(&self) -> Option<Rc<Literal_valueContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn K_AUTOINCREMENT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ASC(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_DESC(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn column_constraint(&mut self,)
	-> Result<Rc<Column_constraintContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			if _la==K_CONSTRAINT {
				...
				recog.base.match_token(K_CONSTRAINT,&mut recog.err_handler)?;
			 ...
			 K_PRIMARY 
				=> {
					...
					if _la==K_AUTOINCREMENT {
						...
						recog.base.match_token(K_AUTOINCREMENT,&mut recog.err_handler)?;
...
pub type Conflict_clauseContext<'input> = BaseParserRuleContext<'input,Conflict_clauseContextExt<'input>>;
...
impl<'input> Conflict_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Conflict_clauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Conflict_clauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Conflict_clauseContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Conflict_clauseContextExt<'input>>{
...
fn K_CONFLICT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn conflict_clause(&mut self,)
	-> Result<Rc<Conflict_clauseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait ExprContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<ExprContextExt<'input>>{
...
fn BIND_PARAMETER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn function_name(&self) -> Option<Rc<Function_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_PAR
/// Returns `None` if there is no child corresponding to token OPEN_PAR
...
fn STAR(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CAST(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CASE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_WHEN_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_WHEN(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_WHEN, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_THEN in current rule
fn K_THEN_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_THEN(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ELSE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_ELSE, 0)
}
fn raise_function(&self) -> Option<Rc<Raise_functionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token PIPE2
/// Returns `None` if there is no child corresponding to token PIPE2
fn PIPE2(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn DIV(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn MOD(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(MOD, 0)
}
/// Retrieves first TerminalNode corresponding to token PLUS
/// Returns `None` if there is no child corresponding to token PLUS
fn PLUS(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(PLUS, 0)
}
/// Retrieves first TerminalNode corresponding to token MINUS
/// Returns `None` if there is no child corresponding to token MINUS
fn MINUS(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(MINUS, 0)
}
/// Retrieves first TerminalNode corresponding to token LT2
/// Returns `None` if there is no child corresponding to token LT2
fn LT2(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn GT2(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn AMP(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn PIPE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(PIPE, 0)
}
/// Retrieves first TerminalNode corresponding to token LT
/// Returns `None` if there is no child corresponding to token LT
fn LT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(LT, 0)
}
/// Retrieves first TerminalNode corresponding to token LT_EQ
/// Returns `None` if there is no child corresponding to token LT_EQ
fn LT_EQ(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(LT_EQ, 0)
}
/// Retrieves first TerminalNode corresponding to token GT
/// Returns `None` if there is no child corresponding to token GT
fn GT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(GT, 0)
}
/// Retrieves first TerminalNode corresponding to token GT_EQ
/// Returns `None` if there is no child corresponding to token GT_EQ
fn GT_EQ(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn EQ(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(EQ, 0)
}
...
fn NOT_EQ1(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn NOT_EQ2(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_AND(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_IS(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_BETWEEN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_IN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_LIKE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_GLOB(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_REGEXP(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_MATCH(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ESCAPE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_ISNULL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_NOTNULL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ExprContextAll<'input>>,ANTLRError> {
		...
		recog.base.enter_recursion_rule(_localctx.clone(), 78, RULE_expr, _p);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			,
				2 =>{
					...
					recog.base.match_token(BIND_PARAMETER,&mut recog.err_handler)?;
			...
			,
				5 =>{
					...
					recog.err_handler.sync(&mut recog.base)?;
					match recog.base.input.la(1) {
					 OPEN_PAR | PLUS | MINUS | TILDE | K_ABORT | K_ACTION | K_ADD | K_AFTER |
					 K_ALL | K_ALTER | K_ANALYZE | K_AND | K_AS | K_ASC | K_ATTACH | K_AUTOINCREMENT |
					 ...
					 K_EXCEPT | K_EXCLUSIVE | K_EXISTS | K_EXPLAIN | K_FAIL | K_FOR | K_FOREIGN |
					 K_FROM | K_FULL | K_GLOB | K_GROUP | K_HAVING | K_IF | K_IGNORE | K_IMMEDIATE |
					 K_IN | K_INDEX | K_INDEXED | K_INITIALLY | K_INNER | K_INSERT | K_INSTEAD |
					 K_INTERSECT | K_INTO | K_IS | K_ISNULL | K_JOIN | K_KEY | K_LEFT |
					 K_LIKE | K_LIMIT | K_MATCH | K_NATURAL | K_NO | K_NOT | K_NOTNULL |
					 K_NULL | K_OF | K_OFFSET | K_ON | K_OR | K_ORDER | K_OUTER | K_PLAN |
					 K_PRAGMA | K_PRIMARY | K_QUERY | K_RAISE | K_RECURSIVE | K_REFERENCES |
					 K_REGEXP | K_REINDEX | K_RELEASE | K_RENAME | K_REPLACE | K_RESTRICT |
					 K_RIGHT | K_ROLLBACK | K_ROW | K_SAVEPOINT | K_SELECT | K_SET | K_TABLE |
					 K_TEMP | K_TEMPORARY | K_THEN | K_TO | K_TRANSACTION | K_TRIGGER |
					 K_UNION | K_UNIQUE | K_UPDATE | K_USING | K_VACUUM | K_VALUES | K_VIEW |
					 K_VIRTUAL | K_WHEN | K_WHERE | K_WITH | K_WITHOUT | IDENTIFIER | NUMERIC_LITERAL |
				...
				if _alt==1 {
					...
					,
						2 =>{
							...
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << STAR) | (1usize << DIV) | (1usize << MOD))) != 0)) } {
								recog.err_handler.recover_inline(&mut recog.base)?;
					...
					,
						4 =>{
							...
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << LT2) | (1usize << GT2) | (1usize << AMP) | (1usize << PIPE))) != 0)) } {
								recog.err_handler.recover_inline(&mut recog.base)?;
					...
					,
						5 =>{
							...
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << LT) | (1usize << LT_EQ) | (1usize << GT) | (1usize << GT_EQ))) != 0)) } {
								recog.err_handler.recover_inline(&mut recog.base)?;
					...
					,
						6 =>{
							...
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << ASSIGN) | (1usize << EQ) | (1usize << NOT_EQ1) | (1usize << NOT_EQ2))) != 0)) } {
								recog.err_handler.recover_inline(&mut recog.base)?;
					...
					,
						10 =>{
							...
							recog.base.match_token(K_BETWEEN,&mut recog.err_handler)?;
						...
						13 =>{
							...
							match  recog.interpreter.adaptive_predict(166,&mut recog.base)? {
								x if x == 1=>{
									...
									recog.base.match_token(K_ESCAPE,&mut recog.err_handler)?;
							...
							match recog.base.input.la(1) {
							 K_ISNULL 
								=> {
									...
									recog.base.match_token(K_ISNULL,&mut recog.err_handler)?;
							 ...
							 K_NOTNULL 
								=> {
									...
									recog.base.match_token(K_NOTNULL,&mut recog.err_handler)?;
...
pub type Foreign_key_clauseContext<'input> = BaseParserRuleContext<'input,Foreign_key_clauseContextExt<'input>>;
...
impl<'input> Foreign_key_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Foreign_key_clauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Foreign_key_clauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Foreign_key_clauseContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Foreign_key_clauseContextExt<'input>>{
...
fn K_REFERENCES(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_REFERENCES, 0)
}
fn foreign_table(&self) -> Option<Rc<Foreign_tableContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_PAR
/// Returns `None` if there is no child corresponding to token OPEN_PAR
...
fn K_DEFERRABLE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_DEFERRABLE, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token K_ON in current rule
fn K_ON_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_ON(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_ON, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_MATCH in current rule
fn K_MATCH_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_MATCH(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_DELETE_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_DELETE(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_DELETE, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_UPDATE in current rule
fn K_UPDATE_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_UPDATE(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_INITIALLY(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_SET_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_SET(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_SET, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_NULL in current rule
fn K_NULL_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_NULL(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_NULL, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_DEFAULT in current rule
fn K_DEFAULT_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_DEFAULT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_DEFAULT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_CASCADE in current rule
fn K_CASCADE_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_CASCADE(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_CASCADE, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_RESTRICT in current rule
fn K_RESTRICT_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_RESTRICT(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_RESTRICT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_NO in current rule
fn K_NO_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_NO(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_NO, i)
}
/// Retrieves all `TerminalNode`s corresponding to token K_ACTION in current rule
fn K_ACTION_all(&self) -> Vec<Rc<TerminalNode<'input,SQLiteParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn K_ACTION(&self, i: usize) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn foreign_key_clause(&mut self,)
	-> Result<Rc<Foreign_key_clauseContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(K_REFERENCES,&mut recog.err_handler)?;
					...
					=> {
						...
						,
							3 =>{
								...
								recog.base.match_token(K_CASCADE,&mut recog.err_handler)?;
						...
						,
							4 =>{
								...
								recog.base.match_token(K_RESTRICT,&mut recog.err_handler)?;
						...
						,
							5 =>{
								...
								recog.base.match_token(K_ACTION,&mut recog.err_handler)?;
			...
			match  recog.interpreter.adaptive_predict(177,&mut recog.base)? {
				x if x == 1=>{
					...
					recog.base.match_token(K_DEFERRABLE,&mut recog.err_handler)?;
					...
					match  recog.interpreter.adaptive_predict(176,&mut recog.base)? {
						x if x == 1=>{
							...
							recog.base.match_token(K_INITIALLY,&mut recog.err_handler)?;
						...
						x if x == 2=>{
							...
							recog.base.match_token(K_IMMEDIATE,&mut recog.err_handler)?;
...
pub type Raise_functionContext<'input> = BaseParserRuleContext<'input,Raise_functionContextExt<'input>>;
...
impl<'input> Raise_functionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Raise_functionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Raise_functionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Raise_functionContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Raise_functionContextExt<'input>>{
...
fn K_RAISE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn error_message(&self) -> Option<Rc<Error_messageContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_ROLLBACK
/// Returns `None` if there is no child corresponding to token K_ROLLBACK
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn raise_function(&mut self,)
	-> Result<Rc<Raise_functionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Indexed_columnContext<'input> = BaseParserRuleContext<'input,Indexed_columnContextExt<'input>>;
...
impl<'input> Indexed_columnContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Indexed_columnContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Indexed_columnContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Indexed_columnContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Indexed_columnContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn indexed_column(&mut self,)
	-> Result<Rc<Indexed_columnContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Table_constraintContext<'input> = BaseParserRuleContext<'input,Table_constraintContextExt<'input>>;
...
impl<'input> Table_constraintContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Table_constraintContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Table_constraintContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Table_constraintContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Table_constraintContextExt<'input>>{
...
fn K_FOREIGN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn table_constraint(&mut self,)
...
impl<'input> With_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<With_clauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,With_clauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait With_clauseContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<With_clauseContextExt<'input>>{
...
fn K_WITH(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
	self.get_token(K_WITH, 0)
}
fn common_table_expression_all(&self) ->  Vec<Rc<Common_table_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn common_table_expression(&self, i: usize) -> Option<Rc<Common_table_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
fn K_RECURSIVE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn with_clause(&mut self,)
	-> Result<Rc<With_clauseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match  recog.interpreter.adaptive_predict(186,&mut recog.base)? {
				x if x == 1=>{
					...
					recog.base.match_token(K_RECURSIVE,&mut recog.err_handler)?;
...
pub type Qualified_table_nameContext<'input> = BaseParserRuleContext<'input,Qualified_table_nameContextExt<'input>>;
...
impl<'input> Qualified_table_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Qualified_table_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Qualified_table_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Qualified_table_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Qualified_table_nameContextExt<'input>>{
...
fn K_INDEXED(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn qualified_table_name(&mut self,)
...
pub type Ordering_termContext<'input> = BaseParserRuleContext<'input,Ordering_termContextExt<'input>>;
...
impl<'input> Ordering_termContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Ordering_termContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Ordering_termContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Ordering_termContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Ordering_termContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn ordering_term(&mut self,)
	-> Result<Rc<Ordering_termContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Pragma_valueContext<'input> = BaseParserRuleContext<'input,Pragma_valueContextExt<'input>>;
...
impl<'input> Pragma_valueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Pragma_valueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Pragma_valueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Pragma_valueContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Pragma_valueContextExt<'input>>{
...
fn STRING_LITERAL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pragma_value(&mut self,)
	-> Result<Rc<Pragma_valueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Common_table_expressionContext<'input> = BaseParserRuleContext<'input,Common_table_expressionContextExt<'input>>;
...
impl<'input> Common_table_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Common_table_expressionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Common_table_expressionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Common_table_expressionContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Common_table_expressionContextExt<'input>>{
...
impl<'input> Common_table_expressionContextAttrs<'input> for Common_table_expressionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn common_table_expression(&mut self,)
...
pub type Result_columnContext<'input> = BaseParserRuleContext<'input,Result_columnContextExt<'input>>;
...
impl<'input> Result_columnContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Result_columnContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Result_columnContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Result_columnContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Result_columnContextExt<'input>>{
...
fn column_alias(&self) -> Option<Rc<Column_aliasContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_AS
/// Returns `None` if there is no child corresponding to token K_AS
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn result_column(&mut self,)
	-> Result<Rc<Result_columnContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Table_or_subqueryContext<'input> = BaseParserRuleContext<'input,Table_or_subqueryContextExt<'input>>;
...
impl<'input> Table_or_subqueryContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Table_or_subqueryContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Table_or_subqueryContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Table_or_subqueryContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Table_or_subqueryContextExt<'input>>{

fn table_name(&self) -> Option<Rc<Table_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn schema_name(&self) -> Option<Rc<Schema_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token DOT
/// Returns `None` if there is no child corresponding to token DOT
...
fn table_alias(&self) -> Option<Rc<Table_aliasContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token K_INDEXED
/// Returns `None` if there is no child corresponding to token K_INDEXED
...
fn table_function_name(&self) -> Option<Rc<Table_function_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_PAR
/// Returns `None` if there is no child corresponding to token OPEN_PAR
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn table_or_subquery(&mut self,)
			...
			match  recog.interpreter.adaptive_predict(211,&mut recog.base)? {
				1 =>{
					...
					match recog.base.input.la(1) {
					 ...
					 K_JOIN | K_LEFT | K_LIMIT | K_NATURAL | K_ON | K_ORDER | K_PRAGMA |
					 K_REINDEX | K_RELEASE | K_REPLACE | K_ROLLBACK | K_SAVEPOINT | K_SELECT |
					 K_UNION | K_UPDATE | K_USING | K_VACUUM | K_VALUES | K_WHERE | K_WITH |
					 UNEXPECTED_CHAR 
						=> {
					    }
...
impl<'input> Join_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Join_clauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Join_clauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Join_clauseContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Join_clauseContextExt<'input>>{
...
fn join_operator_all(&self) ->  Vec<Rc<Join_operatorContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn join_operator(&self, i: usize) -> Option<Rc<Join_operatorContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn join_constraint_all(&self) ->  Vec<Rc<Join_constraintContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn join_constraint(&self, i: usize) -> Option<Rc<Join_constraintContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn join_clause(&mut self,)
	-> Result<Rc<Join_clauseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while _la==COMMA || _la==K_CROSS || ((((_la - 87)) & !0x3f) == 0 && ((1usize << (_la - 87)) & ((1usize << (K_INNER - 87)) | (1usize << (K_JOIN - 87)) | (1usize << (K_LEFT - 87)) | (1usize << (K_NATURAL - 87)))) != 0) {
				{
				{
...
pub type Join_operatorContext<'input> = BaseParserRuleContext<'input,Join_operatorContextExt<'input>>;
...
impl<'input> Join_operatorContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Join_operatorContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Join_operatorContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Join_operatorContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Join_operatorContextExt<'input>>{
...
fn K_JOIN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_NATURAL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_LEFT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_INNER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CROSS(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_OUTER(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn join_operator(&mut self,)
	-> Result<Rc<Join_operatorContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Join_constraintContext<'input> = BaseParserRuleContext<'input,Join_constraintContextExt<'input>>;
...
impl<'input> Join_constraintContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Join_constraintContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Join_constraintContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Join_constraintContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Join_constraintContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn join_constraint(&mut self,)
	-> Result<Rc<Join_constraintContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match recog.base.input.la(1) {
			 ...
			 EOF | SCOL | CLOSE_PAR | COMMA | K_ALTER | K_ANALYZE | K_ATTACH | K_BEGIN |
			 K_COMMIT | K_CREATE | K_CROSS | K_DELETE | K_DETACH | K_DROP | K_END |
			 K_EXCEPT | K_EXPLAIN | K_GROUP | K_INNER | K_INSERT | K_INTERSECT | K_JOIN |
			 K_LEFT | K_LIMIT | K_NATURAL | K_ORDER | K_PRAGMA | K_REINDEX | K_RELEASE |
			 K_REPLACE | K_ROLLBACK | K_SAVEPOINT | K_SELECT | K_UNION | K_UPDATE |
			 K_VACUUM | K_VALUES | K_WHERE | K_WITH | UNEXPECTED_CHAR 
				=> {
			    }
...
impl<'input> Select_coreContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Select_coreContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Select_coreContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Select_coreContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Select_coreContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn select_core(&mut self,)
	-> Result<Rc<Select_coreContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Compound_operatorContext<'input> = BaseParserRuleContext<'input,Compound_operatorContextExt<'input>>;
...
impl<'input> Compound_operatorContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Compound_operatorContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Compound_operatorContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Compound_operatorContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Compound_operatorContextExt<'input>>{
...
fn K_UNION(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_INTERSECT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_EXCEPT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn compound_operator(&mut self,)
...
pub type Signed_numberContext<'input> = BaseParserRuleContext<'input,Signed_numberContextExt<'input>>;
...
impl<'input> Signed_numberContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Signed_numberContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Signed_numberContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Signed_numberContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Signed_numberContextExt<'input>>{
...
fn NUMERIC_LITERAL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn signed_number(&mut self,)
	-> Result<Rc<Signed_numberContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Literal_valueContext<'input> = BaseParserRuleContext<'input,Literal_valueContextExt<'input>>;
...
impl<'input> Literal_valueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Literal_valueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Literal_valueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Literal_valueContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Literal_valueContextExt<'input>>{
...
fn BLOB_LITERAL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CURRENT_TIME(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CURRENT_DATE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CURRENT_TIMESTAMP(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn literal_value(&mut self,)
	-> Result<Rc<Literal_valueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait Unary_operatorContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Unary_operatorContextExt<'input>>{
...
fn TILDE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Unary_operatorContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << PLUS) | (1usize << MINUS) | (1usize << TILDE))) != 0) || _la==K_NOT) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
pub type Error_messageContext<'input> = BaseParserRuleContext<'input,Error_messageContextExt<'input>>;
...
impl<'input> Error_messageContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Error_messageContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Error_messageContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Error_messageContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Error_messageContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn error_message(&mut self,)
	-> Result<Rc<Error_messageContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Module_argumentContext<'input> = BaseParserRuleContext<'input,Module_argumentContextExt<'input>>;
...
impl<'input> Module_argumentContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Module_argumentContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Module_argumentContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Module_argumentContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Module_argumentContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn module_argument(&mut self,)
	-> Result<Rc<Module_argumentContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Column_aliasContext<'input> = BaseParserRuleContext<'input,Column_aliasContextExt<'input>>;
...
impl<'input> Column_aliasContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Column_aliasContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Column_aliasContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Column_aliasContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Column_aliasContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn column_alias(&mut self,)
	-> Result<Rc<Column_aliasContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait KeywordContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<KeywordContextExt<'input>>{
...
fn K_ACTION(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_CASCADE(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_FULL(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_NO(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_OF(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_RESTRICT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_RIGHT(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
fn K_THEN(&self) -> Option<Rc<TerminalNode<'input,SQLiteParserContextType>>> where Self:Sized{
...
pub trait NameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<NameContextExt<'input>>{

fn any_name(&self) -> Option<Rc<Any_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> Function_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Function_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Function_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Function_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Function_nameContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Function_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Database_nameContext<'input> = BaseParserRuleContext<'input,Database_nameContextExt<'input>>;
...
impl<'input> Database_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Database_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Database_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Database_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Database_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn database_name(&mut self,)
	-> Result<Rc<Database_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Schema_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Schema_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Schema_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Schema_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Schema_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn schema_name(&mut self,)
	-> Result<Rc<Schema_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Table_function_nameContext<'input> = BaseParserRuleContext<'input,Table_function_nameContextExt<'input>>;
...
impl<'input> Table_function_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Table_function_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Table_function_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Table_function_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Table_function_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn table_function_name(&mut self,)
...
impl<'input> Table_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Table_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Table_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Table_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Table_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn table_name(&mut self,)
	-> Result<Rc<Table_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Table_or_index_nameContext<'input> = BaseParserRuleContext<'input,Table_or_index_nameContextExt<'input>>;
...
impl<'input> Table_or_index_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Table_or_index_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Table_or_index_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Table_or_index_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Table_or_index_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn table_or_index_name(&mut self,)
...
pub type New_table_nameContext<'input> = BaseParserRuleContext<'input,New_table_nameContextExt<'input>>;
...
impl<'input> New_table_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<New_table_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,New_table_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait New_table_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<New_table_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn new_table_name(&mut self,)
	-> Result<Rc<New_table_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait Column_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Column_nameContextExt<'input>>{
...
pub type Collation_nameContext<'input> = BaseParserRuleContext<'input,Collation_nameContextExt<'input>>;
...
impl<'input> Collation_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Collation_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Collation_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Collation_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Collation_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn collation_name(&mut self,)
	-> Result<Rc<Collation_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Foreign_tableContext<'input> = BaseParserRuleContext<'input,Foreign_tableContextExt<'input>>;
...
impl<'input> Foreign_tableContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Foreign_tableContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Foreign_tableContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Foreign_tableContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Foreign_tableContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn foreign_table(&mut self,)
	-> Result<Rc<Foreign_tableContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Index_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Index_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Index_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Index_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Index_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn index_name(&mut self,)
	-> Result<Rc<Index_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Trigger_nameContext<'input> = BaseParserRuleContext<'input,Trigger_nameContextExt<'input>>;
...
impl<'input> Trigger_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Trigger_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Trigger_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Trigger_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Trigger_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn trigger_name(&mut self,)
	-> Result<Rc<Trigger_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> View_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<View_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,View_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait View_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<View_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn view_name(&mut self,)
	-> Result<Rc<View_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Module_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Module_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Module_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Module_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Module_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn module_name(&mut self,)
	-> Result<Rc<Module_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Pragma_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Pragma_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Pragma_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Pragma_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Pragma_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pragma_name(&mut self,)
	-> Result<Rc<Pragma_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Savepoint_nameContext<'input> = BaseParserRuleContext<'input,Savepoint_nameContextExt<'input>>;
...
impl<'input> Savepoint_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Savepoint_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Savepoint_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Savepoint_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Savepoint_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn savepoint_name(&mut self,)
	-> Result<Rc<Savepoint_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Table_aliasContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Table_aliasContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Table_aliasContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Table_aliasContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Table_aliasContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn table_alias(&mut self,)
	-> Result<Rc<Table_aliasContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Transaction_nameContext<'input> = BaseParserRuleContext<'input,Transaction_nameContextExt<'input>>;
...
impl<'input> Transaction_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Transaction_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Transaction_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Transaction_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Transaction_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn transaction_name(&mut self,)
...
impl<'input> Any_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn SQLiteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Any_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Any_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Any_nameContextAttrs<'input>: SQLiteParserContext<'input> + BorrowMut<Any_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn any_name(&mut self,)
	-> Result<Rc<Any_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match recog.base.input.la(1) {
			 ...
			 K_EXCLUSIVE | K_EXISTS | K_EXPLAIN | K_FAIL | K_FOR | K_FOREIGN | K_FROM |
			 K_FULL | K_GLOB | K_GROUP | K_HAVING | K_IF | K_IGNORE | K_IMMEDIATE |
			 K_IN | K_INDEX | K_INDEXED | K_INITIALLY | K_INNER | K_INSERT | K_INSTEAD |
			 K_INTERSECT | K_INTO | K_IS | K_ISNULL | K_JOIN | K_KEY | K_LEFT | K_LIKE |
			 K_LIMIT | K_MATCH | K_NATURAL | K_NO | K_NOT | K_NOTNULL | K_NULL | K_OF |
			 K_OFFSET | K_ON | K_OR | K_ORDER | K_OUTER | K_PLAN | K_PRAGMA | K_PRIMARY |
			 ...
			 K_THEN | K_TO | K_TRANSACTION | K_TRIGGER | K_UNION | K_UNIQUE | K_UPDATE |
